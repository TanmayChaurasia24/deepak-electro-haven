...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-20 overflow-hidden hero-gradient">
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div
          className="absolute -top-40 -left-40 w-96 h-96 bg-blue-400/50 rounded-full filter blur-3xl opacity-50 parallax"
          // data-speed="0.05"
        ></div>
        <div
          className="absolute top-1/3 -right-20 w-96 h-96 bg-blue-500/30 rounded-full filter blur-3xl opacity-50 parallax"
          data-speed="-0.08"
        ></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 max-w-2xl">
            <div>
              ...
              <p className="mt-6 text-lg md:text-xl text-muted-foreground animate-fade-in animate-delay-100">
                Discover premium home appliances and electronics at Deepak
                Agencies. Find the perfect blend of technology, quality, and
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate-fade-in animate-delay-200">
              ...
              <Button
                variant="outline"
                className="btn-hover-float px-8 py-6 text-base rounded-lg"
              >
                View Collections
              </Button>
            </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-900/30 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse-slow"></div>
              <div className="absolute -bottom-8 left-20 w-72 h-72 bg-blue-900/30 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse-slow"></div>
